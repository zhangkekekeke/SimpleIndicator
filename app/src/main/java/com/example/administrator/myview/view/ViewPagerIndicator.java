...
public class ViewPagerIndicator extends LinearLayout{
    ...
    private static  final  float RADIO_TRIANGLE_WIDHT=1/6F;

    /**
     * 三角形地边的最大宽度
     */
    private  final int DIMENSION_TRIANGLE_WIDTH_MAX=(int)(getScreenWidth()/3*RADIO_TRIANGLE_WIDHT);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mTriangleWidth=(int)(w/mTabVisibleCount*RADIO_TRIANGLE_WIDHT);
    ...
    private View generateTextView(String title) {
        ...
        LinearLayout.LayoutParams lp=new LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,LayoutParams.MATCH_PARENT);
        lp.width=getScreenWidth()/mTabVisibleCount;
        tv.setText(title);
    ...
    private void resetTextViewColor(){
        for(int i=0;i<getChildCount();i++){
            setTextColor(i,COLOR_TEXT_NORMAL);
        }
    }
    ...
    private void highLightTextView(int position){
        resetTextViewColor();
        setTextColor(position,COLOR_TEXT_HIGHLIGHT);
    }
